...
function Signin() {
  ...
  function handleEyeAndPasswordCondition(param) {
    if (param === "eye1") {
      setPasswordCondition({ password1: "text" });
      setEyeCondition({ eye1: "hidden", eye2: "block" });
    } else if (param === "eye2") {
      setPasswordCondition({ password1: "password" });
      setEyeCondition({ eye1: "block", eye2: "hidden" });
    }
  }

  return (
    <div className="sign-in-main w-screen h-screen flex items-center justify-center ">
      <div className="sign-in-container h-full max-w-[1600px] w-full flex items-center justify-center">
        <div className="sign-in w-[88%] h-full flex items-center justify-center">
            ...
            >
              ...
              <div className=" w-full flex items-center justify-between">
                ...
                <button
                  ...
                  className=" montserrat_regular font-bold text-sm cursor-pointer hover:underline media-max-468px:text-xs text-[#A89BDB]"
                >
                  Forgot
                </button>
              </div>
